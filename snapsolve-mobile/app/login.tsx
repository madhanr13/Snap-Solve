      ...
      >
        ...
        >
          ...
          <View style={s.logoArea}>
            ...
            <ThemedText weight="bold" style={[s.appName, { marginTop: 16, color: colors.text }]}>SnapSolve</ThemedText>
            <ThemedText variant="muted" style={s.tagline}>
              AI-powered frugal repair guides
            </ThemedText>
          </View>

          {/* Form */}
          <View style={[s.formCard, { backgroundColor: colors.surface, borderColor: colors.border, shadowColor: isDark ? '#000' : '#475569' }]}>
            <ThemedText weight="bold" style={[s.formTitle, { color: colors.text }]}>Welcome back</ThemedText>
            <ThemedText variant="secondary" style={s.formSubtitle}>Sign in to access your repair assistant</ThemedText>
...
const s = StyleSheet.create({
  ...
  // Form Card
  formCard: {
    borderRadius: 16, padding: 24, borderWidth: 1, gap: 16,
  ...
  formSubtitle: { fontSize: 14, marginTop: -8, marginBottom: 4, opacity: 0.8 },
